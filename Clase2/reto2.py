...
def main():
    ...
    while True:
        ...
        if val[0] == 0:
            test = fn.replace_color(imageBgr, old_color_min=old_color_min, old_color_max=old_color_max, new_color=(0, 200, 255), color_space="HSV")  # Red in HSV
        elif val[0] == 1:
            test = fn.replace_color(imageBgr, old_color_min=old_color_min, old_color_max=old_color_max, new_color=(60, 200, 255), color_space="HSV")  # Green in HSV
        else:
            test = fn.replace_color(imageBgr, old_color_min=old_color_min, old_color_max=old_color_max, new_color=(120, 200, 255), color_space="HSV")  # Blue in HSV
